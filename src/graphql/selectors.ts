import { scalars } from "graphql/client"
import { FromSelector, Selector, SortOrder } from "zeus"
...
export type FiltersFacetType = FacetType & {
  values: (FacetType & { count: number })[]
}
...
export type ProductSearchType = FromSelector<
...
export type CollectionType = FromSelector<
...
export type SearchType = FromSelector<
  typeof SearchSelector,
  "SearchResponse",
  typeof scalars
>
...
export type ProductDetailsFacetType = FromSelector<
...
export type CollectionTileType = FromSelector<
  typeof CollectionTileSelector,
  "Collection",
  typeof scalars
>
...
export type ProductDetailType = FromSelector<
  typeof ProductDetailSelector,
  "Product",
  typeof scalars
>
...
export type NewestProductType = FromSelector<
  typeof NewestProductSelector,
  "Product",
  typeof scalars
>

export type ProductTileType = FromSelector<
  typeof ProductTileSelector,
  "Product",
  typeof scalars
>
...
export type AvailableCountriesType = FromSelector<
  typeof AvailableCountriesSelector,
  "Country",
  typeof scalars
>
...
export type OrderAddressType = FromSelector<
  typeof OrderAddressSelector,
  "OrderAddress",
  typeof scalars
>
...
export type ActiveAddressType = FromSelector<
  typeof ActiveAddressSelector,
  "Address",
  typeof scalars
>
...
export type CurrentUserType = FromSelector<
  typeof CurrentUserSelector,
  "CurrentUser",
  typeof scalars
>
...
export type ActiveCustomerType = FromSelector<
  typeof ActiveCustomerSelector,
  "Customer",
  typeof scalars
>
...
export type PaymentType = FromSelector<
...
export type DiscountsType = FromSelector<
  typeof discountsSelector,
  "Discount",
  typeof scalars
>
...
export type ShippingLineType = FromSelector<
  typeof shippingLineSelector,
  "ShippingLine",
  typeof scalars
>
...
export type ActiveOrderType = FromSelector<
  typeof ActiveOrderSelector,
  "Order",
  typeof scalars
>
...
export type OrderType = FromSelector<
  typeof OrderSelector,
  "Order",
  typeof scalars
>
...
export type ShippingMethodType = FromSelector<
  typeof ShippingMethodsSelector,
  "ShippingMethodQuote",
  typeof scalars
>
...
export type CreateCustomerType = FromSelector<
  typeof CreateCustomerSelector,
  "CreateCustomerInput",
  typeof scalars
>
...
export type CreateAddressType = FromSelector<
  typeof CreateAddressSelector,
  "CreateAddressInput",
  typeof scalars
>
...
export type YAMLProductsType = FromSelector<
  typeof YAMLProductsSelector,
  "Product",
  typeof scalars
>
...
export type ProductVariantTileType = FromSelector<
  typeof productVariantTileSelector,
  "ProductVariant",
  typeof scalars
>
...
export type HomePageSlidersType = FromSelector<
  typeof homePageSlidersSelector,
  "Collection",
  typeof scalars
>

export const ProductSearchResultSelector = Selector("ProductSearchResult")({
  id: true,
  name: true,
  slug: true,
  description: true,
