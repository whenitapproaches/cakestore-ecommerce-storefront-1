...
query will once again return `null`. */
    ...
    collections?: [
      {
        options?:
          | ValueTypes["CollectionListOptions"]
          | undefined
          | null
          | Variable<any, string>
      },
    ...
    search?: [
      { input: ValueTypes["SearchInput"] | Variable<any, string> },
  ...
  ["Mutation"]: AliasType<{
    ...
    removeOrderLine?: [
      ...
      ValueTypes["RemoveOrderItemsResult"],
    ]
    ...
    applyCouponCode?: [
      { couponCode: string | Variable<any, string> },
      ValueTypes["ApplyCouponCodeResult"],
    ]
    removeCouponCode?: [
      { couponCode: string | Variable<any, string> },
      ValueTypes["Order"],
    ...
    updateCustomer?: [
      { input: ValueTypes["UpdateCustomerInput"] | Variable<any, string> },
      ValueTypes["Customer"],
    ]
    ...
    requestUpdateCustomerEmailAddress?: [
      {
        password: string | Variable<any, string>
        newEmailAddress: string | Variable<any, string>
      },
  ...
  ["Collection"]: AliasType<{
    ...
    productVariants?: [
      {
        options?:
          | ValueTypes["ProductVariantListOptions"]
          | undefined
          | null
          | Variable<any, string>
      },
...
current session. */
  ...
  ["PaginatedList"]: AliasType<{
    ...
    totalItems?: boolean | `@${string}`
    ["...on AssetList"]?: Omit<
      ValueTypes["AssetList"],
      keyof ValueTypes["PaginatedList"]
    >
    ["...on CollectionList"]?: Omit<
      ValueTypes["CollectionList"],
      keyof ValueTypes["PaginatedList"]
    >
    ["...on CustomerList"]?: Omit<
    ...
    ["...on ProductVariantList"]?: Omit<
      ...
      keyof ValueTypes["PaginatedList"]
    >
    ["...on PromotionList"]?: Omit<
      ValueTypes["PromotionList"],
      keyof ValueTypes["PaginatedList"]
    >
    ["...on CountryList"]?: Omit<
      ValueTypes["CountryList"],
      keyof ValueTypes["PaginatedList"]
    >
    ["...on ProvinceList"]?: Omit<
      ValueTypes["ProvinceList"],
      keyof ValueTypes["PaginatedList"]
    >
    ["...on RoleList"]?: Omit<
      ValueTypes["RoleList"],
  ...
  ["Node"]: AliasType<{
    ...
    >
    ["...on Surcharge"]?: Omit<
      ValueTypes["Surcharge"],
      keyof ValueTypes["Node"]
    >
    ["...on PaymentMethod"]?: Omit<
      ValueTypes["PaymentMethod"],
      keyof ValueTypes["Node"]
    >
    ["...on ProductOptionGroup"]?: Omit<
      ValueTypes["ProductOptionGroup"],
      keyof ValueTypes["Node"]
    >
    ["...on ProductOption"]?: Omit<
      ValueTypes["ProductOption"],
      keyof ValueTypes["Node"]
    >
    ["...on Product"]?: Omit<ValueTypes["Product"], keyof ValueTypes["Node"]>
    ["...on ProductVariant"]?: Omit<
      ValueTypes["ProductVariant"],
      keyof ValueTypes["Node"]
    >
    ["...on Promotion"]?: Omit<
      ValueTypes["Promotion"],
      keyof ValueTypes["Node"]
    >
    ...
    ["...on ShippingMethod"]?: Omit<
      ValueTypes["ShippingMethod"],
      keyof ValueTypes["Node"]
    >
    ["...on Tag"]?: Omit<ValueTypes["Tag"], keyof ValueTypes["Node"]>
    ["...on TaxCategory"]?: Omit<
      ValueTypes["TaxCategory"],
      keyof ValueTypes["Node"]
    >
    ...
    ["...on AuthenticationMethod"]?: Omit<
      ValueTypes["AuthenticationMethod"],
      keyof ValueTypes["Node"]
    >
  ...
  ["ErrorResult"]: AliasType<{
    ...
    ["...on GuestCheckoutError"]?: Omit<
      ValueTypes["GuestCheckoutError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on OrderLimitError"]?: Omit<
      ValueTypes["OrderLimitError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on NegativeQuantityError"]?: Omit<
      ValueTypes["NegativeQuantityError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on InsufficientStockError"]?: Omit<
      ValueTypes["InsufficientStockError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on CouponCodeInvalidError"]?: Omit<
      ValueTypes["CouponCodeInvalidError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on CouponCodeExpiredError"]?: Omit<
      ValueTypes["CouponCodeExpiredError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on CouponCodeLimitError"]?: Omit<
      ValueTypes["CouponCodeLimitError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on OrderModificationError"]?: Omit<
      ValueTypes["OrderModificationError"],
      keyof ValueTypes["ErrorResult"]
    >
    ...
    ["...on NoActiveOrderError"]?: Omit<
      ValueTypes["NoActiveOrderError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on OrderPaymentStateError"]?: Omit<
      ValueTypes["OrderPaymentStateError"],
      keyof ValueTypes["ErrorResult"]
    >
    ...
    ["...on PaymentFailedError"]?: Omit<
      ValueTypes["PaymentFailedError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on PaymentDeclinedError"]?: Omit<
      ValueTypes["PaymentDeclinedError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on AlreadyLoggedInError"]?: Omit<
      ValueTypes["AlreadyLoggedInError"],
      keyof ValueTypes["ErrorResult"]
    >
    ["...on MissingPasswordError"]?: Omit<
      ValueTypes["MissingPasswordError"],
      keyof ValueTypes["ErrorResult"]
    >
...
* ID=1 AND (ID=2 OR ID=3): `{ facetValueFilters: [{ and: 1 }, { or: [2,3] }] }` */
  ...
  ["SearchInput"]: {
    ...
    facetValueFilters?:
      | Array<ValueTypes["FacetValueFilterInput"]>
      | undefined
      | null
      | Variable<any, string>
    ...
    sort?:
      | ValueTypes["SearchResultSortParameter"]
      | undefined
      | null
      | Variable<any, string>
...
@docsCategory common */
  ...
  ["CustomField"]: AliasType<{
    ...
    ["...on IntCustomFieldConfig"]?: Omit<
      ValueTypes["IntCustomFieldConfig"],
      keyof ValueTypes["CustomField"]
    >
    ["...on FloatCustomFieldConfig"]?: Omit<
      ValueTypes["FloatCustomFieldConfig"],
      keyof ValueTypes["CustomField"]
    >
    ...
    ["...on TextCustomFieldConfig"]?: Omit<
      ValueTypes["TextCustomFieldConfig"],
      keyof ValueTypes["CustomField"]
    >
...
See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/datetime-local#Additional_attributes */
  ...
  ["CustomerGroup"]: AliasType<{
    ...
    customers?: [
      {
        options?:
          | ValueTypes["CustomerListOptions"]
          | undefined
          | null
          | Variable<any, string>
      },
  ...
  ["CustomerListOptions"]: {
    ...
    sort?:
      | ValueTypes["CustomerSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["CustomerFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
    filterOperator?:
      | ValueTypes["LogicalOperator"]
      | undefined
      | null
      | Variable<any, string>
  }
  ...
  ["Facet"]: AliasType<{
    ...
    valueList?: [
      {
        options?:
          | ValueTypes["FacetValueListOptions"]
          | undefined
          | null
          | Variable<any, string>
      },
  ...
  ["FacetValueListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["FacetValueSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["FacetValueFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["HistoryEntryListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["HistoryEntrySortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["HistoryEntryFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
...
sum of `OrderLine.discountedLinePrice` values. */
    ...
    history?: [
      {
        options?:
          | ValueTypes["HistoryEntryListOptions"]
          | undefined
          | null
          | Variable<any, string>
      },
...
and refund calculations. */
  ...
  ["SearchResponse"]: AliasType<{
    items?: ValueTypes["SearchResult"] | ValueTypes["ProductSearchResult"]
    totalItems?: boolean | `@${string}`
...
by the search, and in what quantity. */
  ...
  ["CustomSearchResultAsset"]: AliasType<{
    preview: boolean | `@${string}`
  }>
  ["ProductSearchResult"]: AliasType<{
    id: boolean | `@${string}`
    name: boolean | `@${string}`
    slug: boolean | `@${string}`
    description: boolean | `@${string}`
...
data generated by the payment provider. */
  ...
  ["CollectionListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["CollectionSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["CollectionFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["FacetListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["FacetSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["FacetFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["OrderListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["OrderSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["OrderFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["ProductListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["ProductSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["ProductFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["ProductVariantListOptions"]: {
    ...
    /** Specifies which properties to sort the results by */
    sort?:
      | ValueTypes["ProductVariantSortParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Allows the results to be filtered */
    filter?:
      | ValueTypes["ProductVariantFilterParameter"]
      | undefined
      | null
      | Variable<any, string>
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  ...
  ["ProductVariantFilterParameter"]: {
    ...
    productId?:
      | ValueTypes["IDOperators"]
      | undefined
      | null
      | Variable<any, string>
    createdAt?:
      | ValueTypes["DateOperators"]
      | undefined
      | null
      | Variable<any, string>
    updatedAt?:
...
query will once again return `null`. */
    ...
    search?: [
      { input: ResolverInputTypes["SearchInput"] },
      ResolverInputTypes["SearchResponse"],
    ]
    customSearch?: [
      { input: ResolverInputTypes["CustomSearchInput"] },
      ResolverInputTypes["SearchResponse"],
    ]
    __typename?: boolean | `@${string}`
  }>
  ["Mutation"]: AliasType<{
    addItemToOrder?: [
      ...
      ResolverInputTypes["UpdateOrderItemsResult"],
    ]
    removeOrderLine?: [
      { orderLineId: string },
      ResolverInputTypes["RemoveOrderItemsResult"],
    ]
    /** Remove all OrderLine from the Order */
    ...
    applyCouponCode?: [
      { couponCode: string },
      ResolverInputTypes["ApplyCouponCodeResult"],
    ]
    removeCouponCode?: [{ couponCode: string }, ResolverInputTypes["Order"]]
    transitionOrderToState?: [
      { state: string },
      ResolverInputTypes["TransitionOrderToStateResult"],
    ]
    setOrderShippingAddress?: [
    ...
    authenticate?: [
      {
        input: ResolverInputTypes["AuthenticationInput"]
        rememberMe?: boolean | undefined | null
      },
    ...
    updateCustomer?: [
      { input: ResolverInputTypes["UpdateCustomerInput"] },
    ...
    updateCustomerAddress?: [
      { input: ResolverInputTypes["UpdateAddressInput"] },
      ResolverInputTypes["Address"],
    ]
    ...
    updateCustomerEmailAddress?: [
      { token: string },
      ResolverInputTypes["UpdateCustomerEmailAddressResult"],
    ]
    requestPasswordReset?: [
      { emailAddress: string },
      ResolverInputTypes["RequestPasswordResetResult"],
    ]
    resetPassword?: [
      { token: string; password: string },
      ResolverInputTypes["ResetPasswordResult"],
    ]
    __typename?: boolean | `@${string}`
  }>
  ["Address"]: AliasType<{
  ...
  ["Collection"]: AliasType<{
    ...
    productVariants?: [
      {
        options?:
          | ResolverInputTypes["ProductVariantListOptions"]
          | undefined
          | null
      },
...
current session. */
  ...
  ["PaginatedList"]: AliasType<{
    ...
    >
    ["...on PromotionList"]?: Omit<
      ResolverInputTypes["PromotionList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    ["...on CountryList"]?: Omit<
      ResolverInputTypes["CountryList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    ["...on ProvinceList"]?: Omit<
      ResolverInputTypes["ProvinceList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    ["...on RoleList"]?: Omit<
      ResolverInputTypes["RoleList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    ["...on ShippingMethodList"]?: Omit<
    ...
    >
    ["...on TagList"]?: Omit<
      ResolverInputTypes["TagList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    ["...on TaxRateList"]?: Omit<
      ResolverInputTypes["TaxRateList"],
      keyof ResolverInputTypes["PaginatedList"]
    >
    __typename?: boolean | `@${string}`
  }>
  ["Node"]: AliasType<{
    ...
    >
    ["...on CustomerGroup"]?: Omit<
      ResolverInputTypes["CustomerGroup"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Customer"]?: Omit<
      ResolverInputTypes["Customer"],
    ...
    >
    ["...on FacetValue"]?: Omit<
      ResolverInputTypes["FacetValue"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Facet"]?: Omit<
      ResolverInputTypes["Facet"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on HistoryEntry"]?: Omit<
      ResolverInputTypes["HistoryEntry"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Order"]?: Omit<
    ...
    >
    ["...on ProductOptionGroup"]?: Omit<
      ResolverInputTypes["ProductOptionGroup"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on ProductOption"]?: Omit<
    ...
    >
    ["...on Country"]?: Omit<
      ResolverInputTypes["Country"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Province"]?: Omit<
      ResolverInputTypes["Province"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Role"]?: Omit<
    ...
    >
    ["...on Seller"]?: Omit<
      ResolverInputTypes["Seller"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on ShippingMethod"]?: Omit<
      ResolverInputTypes["ShippingMethod"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on Tag"]?: Omit<
      ResolverInputTypes["Tag"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on TaxCategory"]?: Omit<
      ResolverInputTypes["TaxCategory"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on TaxRate"]?: Omit<
      ResolverInputTypes["TaxRate"],
      keyof ResolverInputTypes["Node"]
    >
    ["...on User"]?: Omit<
...
* ID=1 AND (ID=2 OR ID=3): `{ facetValueFilters: [{ and: 1 }, { or: [2,3] }] }` */
  ...
  ["SearchInput"]: {
    ...
    facetValueFilters?:
      | Array<ResolverInputTypes["FacetValueFilterInput"]>
      | undefined
      | null
...
See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/datetime-local#Additional_attributes */
  ...
  ["HistoryEntryListOptions"]: {
    ...
    /** Allows the results to be filtered */
    filter?:
      | ResolverInputTypes["HistoryEntryFilterParameter"]
      | undefined
      | null
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
    filterOperator?: ResolverInputTypes["LogicalOperator"] | undefined | null
...
sum of `OrderLine.discountedLinePrice` values. */
    ...
    history?: [
      {
        options?:
          | ResolverInputTypes["HistoryEntryListOptions"]
          | undefined
          | null
      },
      ResolverInputTypes["HistoryEntryList"],
...
by the search, and in what quantity. */
  ...
  ["Region"]: AliasType<{
    ...
    ["...on Country"]?: Omit<
      ResolverInputTypes["Country"],
      keyof ResolverInputTypes["Region"]
    >
    ["...on Province"]?: Omit<
      ResolverInputTypes["Province"],
      keyof ResolverInputTypes["Region"]
...
data generated by the payment provider. */
  ...
  ["ProductVariantListOptions"]: {
    ...
    /** Allows the results to be filtered */
    filter?:
      | ResolverInputTypes["ProductVariantFilterParameter"]
      | undefined
      | null
    /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
    filterOperator?: ResolverInputTypes["LogicalOperator"] | undefined | null
...
general anonymous access to Order data. */
  ...
  ["Mutation"]: {
    ...
    transitionOrderToState?:
      | ModelTypes["TransitionOrderToStateResult"]
      | undefined
...
current session. */
  ...
  ["Node"]: {
    ...
    ["...on AuthenticationMethod"]: "__union" &
      GraphQLTypes["AuthenticationMethod"]
  ...
  ["ErrorResult"]: {
    ...
    errorCode: GraphQLTypes["ErrorCode"]
    message: string
    ["...on NativeAuthStrategyError"]: "__union" &
      GraphQLTypes["NativeAuthStrategyError"]
    ["...on InvalidCredentialsError"]: "__union" &
      GraphQLTypes["InvalidCredentialsError"]
    ["...on OrderStateTransitionError"]: "__union" &
      GraphQLTypes["OrderStateTransitionError"]
    ["...on EmailAddressConflictError"]: "__union" &
      GraphQLTypes["EmailAddressConflictError"]
    ["...on GuestCheckoutError"]: "__union" & GraphQLTypes["GuestCheckoutError"]
    ["...on OrderLimitError"]: "__union" & GraphQLTypes["OrderLimitError"]
    ["...on NegativeQuantityError"]: "__union" &
      GraphQLTypes["NegativeQuantityError"]
    ["...on InsufficientStockError"]: "__union" &
      GraphQLTypes["InsufficientStockError"]
    ["...on CouponCodeInvalidError"]: "__union" &
      GraphQLTypes["CouponCodeInvalidError"]
    ["...on CouponCodeExpiredError"]: "__union" &
      GraphQLTypes["CouponCodeExpiredError"]
    ["...on CouponCodeLimitError"]: "__union" &
      GraphQLTypes["CouponCodeLimitError"]
    ["...on OrderModificationError"]: "__union" &
      GraphQLTypes["OrderModificationError"]
    ["...on IneligibleShippingMethodError"]: "__union" &
      GraphQLTypes["IneligibleShippingMethodError"]
    ["...on NoActiveOrderError"]: "__union" & GraphQLTypes["NoActiveOrderError"]
    ["...on OrderPaymentStateError"]: "__union" &
      GraphQLTypes["OrderPaymentStateError"]
    ["...on IneligiblePaymentMethodError"]: "__union" &
      GraphQLTypes["IneligiblePaymentMethodError"]
    ["...on PaymentFailedError"]: "__union" & GraphQLTypes["PaymentFailedError"]
    ["...on PaymentDeclinedError"]: "__union" &
      GraphQLTypes["PaymentDeclinedError"]
    ["...on AlreadyLoggedInError"]: "__union" &
      GraphQLTypes["AlreadyLoggedInError"]
    ["...on MissingPasswordError"]: "__union" &
      GraphQLTypes["MissingPasswordError"]
    ["...on PasswordValidationError"]: "__union" &
      GraphQLTypes["PasswordValidationError"]
    ["...on PasswordAlreadySetError"]: "__union" &
      GraphQLTypes["PasswordAlreadySetError"]
    ["...on VerificationTokenInvalidError"]: "__union" &
      GraphQLTypes["VerificationTokenInvalidError"]
    ["...on VerificationTokenExpiredError"]: "__union" &
      GraphQLTypes["VerificationTokenExpiredError"]
    ["...on IdentifierChangeTokenInvalidError"]: "__union" &
      GraphQLTypes["IdentifierChangeTokenInvalidError"]
    ["...on IdentifierChangeTokenExpiredError"]: "__union" &
      GraphQLTypes["IdentifierChangeTokenExpiredError"]
    ["...on PasswordResetTokenInvalidError"]: "__union" &
      GraphQLTypes["PasswordResetTokenInvalidError"]
    ["...on PasswordResetTokenExpiredError"]: "__union" &
      GraphQLTypes["PasswordResetTokenExpiredError"]
...
@docsCategory common */
  ...
  ["CustomField"]: {
    ...
    nullable?: boolean | undefined
    ui?: GraphQLTypes["JSON"] | undefined
    ["...on StringCustomFieldConfig"]: "__union" &
      GraphQLTypes["StringCustomFieldConfig"]
    ["...on LocaleStringCustomFieldConfig"]: "__union" &
      GraphQLTypes["LocaleStringCustomFieldConfig"]
    ["...on IntCustomFieldConfig"]: "__union" &
      GraphQLTypes["IntCustomFieldConfig"]
    ["...on FloatCustomFieldConfig"]: "__union" &
      GraphQLTypes["FloatCustomFieldConfig"]
    ["...on BooleanCustomFieldConfig"]: "__union" &
      GraphQLTypes["BooleanCustomFieldConfig"]
    ["...on DateTimeCustomFieldConfig"]: "__union" &
      GraphQLTypes["DateTimeCustomFieldConfig"]
    ["...on RelationCustomFieldConfig"]: "__union" &
      GraphQLTypes["RelationCustomFieldConfig"]
    ["...on TextCustomFieldConfig"]: "__union" &
      GraphQLTypes["TextCustomFieldConfig"]
    ["...on LocaleTextCustomFieldConfig"]: "__union" &
      GraphQLTypes["LocaleTextCustomFieldConfig"]
  }
  ["StringCustomFieldConfig"]: {
